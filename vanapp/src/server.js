...
createServer({
    ...
    routes() {
        ...
        this.get("/vans", (schema, request) => {
            //return new Response(400, {}, {error: "Error fetching data", status: 400})
        ...
        this.post("/login", (schema, request)=>{
            ...
            if(!foundUser){
                return new Response(404, {}, {message:"No user with those credentials"})
            }
            foundUser.password= undefined //do not send password back to client
            return{
                user: foundUser,
